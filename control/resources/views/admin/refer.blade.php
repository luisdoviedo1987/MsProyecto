    ...
    <div  class="gform_body">
        <div  class="gform_page" id="gform_page_1_1">
            ...
            <ul>
                ...
                <li>{url_afiliacion} = Url de la afiliación</li>
                <li>{codigoReferido} = Código de referido</li>
            </ul>
            <div class="gform_page_fields">
                <ul class="gform_fields top_label form_sublabel_below description_below" id="gform_fields_1">
                    <div class="row">
                        <form method="post" action="{{route('admin.refer.email')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-md-12">
