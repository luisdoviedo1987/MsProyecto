...
<div  class="gf_browser_gecko gform_wrapper" id="gform_wrapper_1">
    ...
    <div  class="gform_body">
        <div  class="gform_page" id="gform_page_1_1">
            <h2 >Correos</h2>
            <p>En esta sección podrá modificar el correo de bienvenida.</p>
            <p>Utilice el siguiente glosario para la construcción del correo de validación.</p>
            <ul>
                <li>{link} = Link encriptado para cambio de contraseña (el botón lleva el link)</li>
                <li>{url} = Donde se direcciona al usuario luego del cambio de contraseña</li>
            </ul>
            <div class="gform_page_fields">
                <ul class="gform_fields top_label form_sublabel_below description_below" id="gform_fields_1">
                    <div class="row">
                        <form method="post" action="{{route('admin.welcome.email')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-md-12">
